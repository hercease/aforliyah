						...
						<div className="container"> 
						  ...
						  <div className="box-mw-824">
							    <div className="box-detail-info">
								  <p className="neutral-1000">Welcome to Afoliyah Travels! By using our website and services, you agree to comply with the following terms of service. These terms govern your access to and use of our services, including bookings, payments, and interactions with our platform.</p>
								  <p> <strong>General Conditions:  </strong>You must be at least 18 years old to use our services. By accessing or using the website, you agree that you will not use it for any illegal or unauthorized purpose. You are responsible for ensuring that all information provided is accurate and up-to-date.</p>
								  <p> <strong>Service Availability:  </strong>Our services are available globally but subject to availability in certain regions. We are not responsible for interruptions or delays caused by external factors such as server downtimes or network issues. We reserve the right to modify or discontinue our services at any time without notice.</p>
								  <p> <strong>Bookings and Payments: </strong>All bookings made through Afoliyah Travels are subject to availability. We reserve the right to modify pricing or cancel bookings if payment is not received in full. Payments must be completed before services are confirmed. We accept major credit cards, debit cards, and mobile payment platforms.</p>
								  <p> <strong>Changes and Cancellations:  </strong>Any changes or cancellations must be made according to the specific terms provided at the time of booking. Failure to comply may result in charges or forfeiture of payments. Please review our cancellation policies carefully before making a booking.</p>
								  <p> <strong>Limitation of Liability:  </strong>We are not liable for any loss or damage arising from the use of our services, including but not limited to personal injury, lost profits, or data breaches. We are not responsible for any third-party services or products offered through our platform.</p>
								  <p> <strong>Intellectual Property:  </strong>All content on Afoliyah Travels is protected by intellectual property laws. You may not copy, reproduce, or distribute any content without our express permission. Our trademarks, logos, and branding are the exclusive property of Afoliyah Travels.</p>
								  <p> <strong>Governing Law:  </strong>These terms are governed by the laws of Nigeria. Any disputes arising from the use of our services shall be resolved in the courts of FCT-Abuja.</p>
