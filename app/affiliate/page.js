			...
			<main style={{ background: "var(--bs-gray-100)" }} className="main">
				...
				<div className="container py-3">
					<div className="col-lg-4 mx-auto">
						...
						<div className="card-header h5">Get Started Today</div>
							<div className="mb-3">
								<label>Company Name</label>
								<input className="form-control" name="" placeholder="Company name" />
							</div>
							<div className="mb-3">
								<label>Contact Person name</label>
								<input className="form-control" name="" placeholder="Contact Person name" />
							</div>
							<div className="mb-3">
								<label>Contact role</label>
								<input className="form-control" name="" placeholder="Contact role" />
							</div>
							<div className="mb-3">
								<label>Company Address</label>
								<input className="form-control" name="" placeholder="Company Address" />
							</div>
							<div className="mb-3">
								<label>Phone no</label>
								<input className="form-control" name="" placeholder="Phone no" />
							</div>
							<div className="mb-3">
