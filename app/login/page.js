		...
		const onSubmit = (data) => {
			...
			try {
				...
				if(response.data.status===false){
					...
					setCookie(null, 'afotravelstoken', response.data.email, { maxAge: 7 * 24 * 60 * 60, path: '/', });
					router.push('/profile');
				}else{
					toast.error(response.data.message,{duration: 10000});
				}
			...
			<main style={{ background: "var(--bs-gray-100)" }} className="main">
				...
				<section className="box-section box-breadcrumb background-100">
					<div className="container"> 
						...
						<li> <span className="text-breadcrumb">Login</span></li>
						</ul>
					</div>
				</section>
					...
					<div className="col-lg-4 mx-auto">
						<div className="card border-0 shadow-lg">
                            <div className="card-body">
                                <div className="card-header h6 mb-2"> <i className="bi bi-hand-thumbs-up-fill text-primary"></i> Welcome back!!!!</div>
								<form onSubmit={handleSubmit(onSubmit)}>
                                    <div className="mb-3">
                                        <label><i className="bi bi-envelope"></i> Email</label>
                                        <input className="form-control form-control-sm" {...register("email", { required: "Email is required"  })} placeholder="Enter email address" />
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <div className="input-group">
                                            <input type={showPassword ? 'text' : 'password'}  {...register("password", { required: "Password is required"  })}  className="form-control form-control-sm" id="floatingInputGroup3" placeholder="Enter your password" {...register("password", { required: "Password is required"  })} />
                                    ...
                                    <div className="form-group"> 
                                        <div className="box-remember-forgot">   
                                            ...
                                            <div className="forgotpass"> <a className="text-xs-medium neutral-500" href="#">Forgot  password?</a></div>
                                        </div>
                                    </div>
									<input type="hidden" {...register("request_type")} value="login" />
                                    <div className='mb-3'>
