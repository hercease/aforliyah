					...
					<section className="box-section box-breadcrumb background-100">
						<div className="container"> 
						  <ul className="breadcrumbs"> 
							...
							<li> <span className="text-breadcrumb">Cookie Policy</span></li>
						  </ul>
						</div>
					</section>
						...
						<div className="container"> 
						  <div className="box-mw-824">
							<div className="text-center">
							  ...
							  <Image width={20} height={20} className="mr-10" src="/assets/imgs/page/homepage4/earth.svg" alt="Travile" />Cookies</span></div>
							  <h2 className="mt-15 mb-15 neutral-1000 wow fadeInUp">Cookie Policy</h2>
							</div>
						  </div>
						  <div className="box-mw-824">
							    <div className="box-detail-info">
									<p>This Cookies Policy explains how Afoliyah Travels uses cookies and similar technologies to provide, customize, evaluate, and improve our services.</p>
									
									<p><strong>What Are Cookies?:</strong> Cookies are small text files that are stored on your device when you visit a website. They help us recognize you and remember your preferences during future visits.</p>

									<p><strong>Types of Cookies We Use:</strong></p>
									<ul>
									  <li><strong>Essential Cookies:</strong> These are necessary for our site to function and cannot be disabled.</li>
									  <li><strong>Analytics Cookies:</strong> We use these to track user interactions and improve our services.</li>
									  <li><strong>Advertising Cookies:</strong> These cookies allow us to show relevant ads based on your browsing behavior.</li>
									</ul>

									<p><strong>Managing Cookies:</strong> You can disable cookies in your browser settings. However, disabling essential cookies may limit the functionality of our website.</p>

									<p><strong>Third-Party Cookies:</strong> Some of our service providers may place cookies on your device when you use their services through our platform. These include analytics and ad providers.</p>
								</div>
