						  ...
						  <div className="row align-items-end">
							...
							<span className="btn btn-brand-secondary"> 
											<Image 
												...
												priority  className="mr-10" src="/assets/imgs/page/homepage9/real.svg" />
												Afotravels</span>
							  <h1 className="neutral-1000 mt-15 mb-15">
								 Welcome<span> to </span>Afotravels  <span>booking system</span></h1>
							  <p className="text-xl-medium neutral-500">Make it easier for everyone to experience the world at large</p>
							</div>
							<div className="col-lg-5"> 
							  <div className="box-icon-flight">
											<Image 
												...
												alt="Afotravels"    // Bootstrap class for right margin
												quality={100}        // Image quality (0-100)
												priority src="/assets/imgs/page/pages/flight.png" 
											/>
								<h6 className="neutral-1000">Our mission is to provide exceptional travel solutions that meet the diverse needs of our clients, offering personalized services and innovative travel options at competitive prices.</h6>
							  </div>
							</div>
						  </div>
						</div>
					...
					<section className="section-box box-why-book-travila-5 background-5">
						<div className="container"> 
						  <div className="row align-items-center"> 
							<div className="col-lg-6 mb-30"><span className="btn btn-brand-secondary background-0 wow fadeInUp"> <Image alt="Afotravels" quality={100} layout="intrinsic" width={20} height={20} className="mr-10" src="/assets/imgs/page/homepage4/earth.svg" />Why book at Afotravels?</span>
							  <p className="text-xl-medium neutral-1000 mb-30 wow fadeInUp">Choose one style or create a package, fill your passports with adventures together.</p>
							  ...
							  <div className="row">
								<div className="col-lg-6 col-sm-6 pt-30"> 
								  <div className="card-why card-why-2 background-1 wow fadeInUp"> 
									<div className="card-image"> <Image quality={100} priority layout="intrinsic" alt="aforliyah" width={20} height={20} src="/assets/imgs/page/homepage6/experience.png" /></div>
									<div className="card-info"> 
									  <h6 className="text-xl-bold neutral-1000">Our Vision</h6>
									  <p className="text-lg-medium neutral-500">To become the preferred travel agency for clients seeking convenience, affordability, and excellence in their travel experience.</p>
									</div>
								  </div>
								  <div className="card-why card-why-2 background-3 wow fadeInUp"> 
									<div className="card-image"> 
									  <svg width={48} height={46} viewBox="0 0 48 46" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<path d="M17.125 27.75H30.875C31.3928 27.75 31.8125 27.3303 31.8125 26.8125C31.8125 26.2947 31.3928 25.875 30.875 25.875H17.125C16.6072 25.875 16.1875 26.2947 16.1875 26.8125C16.1875 27.3303 16.6072 27.75 17.125 27.75Z" fill="black"></path>
										<path d="M17.125 31.5H24C24.5178 31.5 24.9375 31.0803 24.9375 30.5625C24.9375 30.0447 24.5178 29.625 24 29.625H17.125C16.6072 29.625 16.1875 30.0447 16.1875 30.5625C16.1875 31.0803 16.6072 31.5 17.125 31.5Z" fill="black"></path>
										<path d="M17.125 35.25H24C24.5178 35.25 24.9375 34.8303 24.9375 34.3125C24.9375 33.7947 24.5178 33.375 24 33.375H17.125C16.6072 33.375 16.1875 33.7947 16.1875 34.3125C16.1875 34.8303 16.6072 35.25 17.125 35.25Z" fill="black"></path>
										<path d="M18.375 23.9375H19.625C20.1428 23.9375 20.5625 23.5178 20.5625 23C20.5625 22.4822 20.1428 22.0625 19.625 22.0625H18.375C17.8572 22.0625 17.4375 22.4822 17.4375 23C17.4375 23.5178 17.8572 23.9375 18.375 23.9375Z" fill="black"></path>
										<path d="M24.625 22.0625H23.375C22.8572 22.0625 22.4375 22.4822 22.4375 23C22.4375 23.5178 22.8572 23.9375 23.375 23.9375H24.625C25.1428 23.9375 25.5625 23.5178 25.5625 23C25.5625 22.4822 25.1428 22.0625 24.625 22.0625Z" fill="black"></path>
										<path d="M29.625 22.0625H28.375C27.8572 22.0625 27.4375 22.4822 27.4375 23C27.4375 23.5178 27.8572 23.9375 28.375 23.9375H29.625C30.1428 23.9375 30.5625 23.5178 30.5625 23C30.5625 22.4822 30.1428 22.0625 29.625 22.0625Z" fill="black"></path>
										<path d="M29 29.625C27.4492 29.625 26.1875 30.8867 26.1875 32.4375C26.1875 33.9883 27.4492 35.25 29 35.25C30.5508 35.25 31.8125 33.9883 31.8125 32.4375C31.8125 30.8867 30.5508 29.625 29 29.625ZM29 33.375C28.4831 33.375 28.0625 32.9544 28.0625 32.4375C28.0625 31.9206 28.4831 31.5 29 31.5C29.5169 31.5 29.9375 31.9206 29.9375 32.4375C29.9375 32.9544 29.5169 33.375 29 33.375Z" fill="black"></path>
										<defs>
							...
							<div className="col-lg-5">
							  <div className="row"> 
								<div className="col-md-7 mb-30">
									<Image alt="aforliyah" width={200} height={420} quality={100}  className="bdrd8 w-100" src="/assets/imgs/page/homepage1/pay1.png" /></div>
									<div className="col-md-5 mb-30">
										<Image alt="aforliyah" width={200} height={200} quality={100} className="bdrd8 w-100 mb-15" src="/assets/imgs/page/homepage1/pay2.png" />
										<Image alt="aforliyah" className="bdrd8 w-100" width={200} height={200} quality={100} src="/assets/imgs/page/homepage1/pay3.png" /></div>
									</div>
								</div>
							<div className="col-lg-7 mb-30">
							  <div className="box-left-payment"><span className="btn btn-tag btn-brand-secondary">What We Offer</span>
								<h4 className="title-why mb-25 mt-10 neutral-1000">At Afoliyah Travels, we offer a variety of travel services, including:</h4>
								<p className="text-x-medium neutral-500 mb-35"><strong>Flight Bookings:</strong> Domestic and international flight reservations at competitive rates.</p>
								<p className="text-x-medium neutral-500 mb-35"><strong>Hotel Reservations:</strong> A selection of hotels to suit every budget and preference.</p>
								<p className="text-x-medium neutral-500 mb-35"><strong>Car Rentals:</strong> Reliable car rental services for business or leisure travel.</p>
								<p className="text-x-medium neutral-500 mb-35"><strong>Vacation Packages: </strong> Customized vacation packages to exciting destinations around the world.</p>
								<p className="text-x-medium neutral-500 mb-35"><strong>Travel Consultation: </strong> Expert travel advice and planning services.</p>
								<div className="payment-method"> 
								  <div className="box-swiper mt-30">
									<Swiper
										...
										spaceBetween={10} 
										slidesPerView={4}
										className="swiper-container swiper-group-payment"
									>
									
										<div className="swiper-wrapper">
											<SwiperSlide>
												<div className="btn btn-payment"> 
													<Image alt="aforliyah" priority layout="intrinsic" width={60} height={35}  src="/assets/imgs/template/icons/paypal.png" />
												</div>
											</SwiperSlide>
											<SwiperSlide>
												<div className="btn btn-payment"> 
													<Image alt="aforliyah" priority layout="intrinsic" width={50} height={30} src="/assets/imgs/template/icons/stripe.png" />
												</div>
											</SwiperSlide>
											<SwiperSlide>
												<div className="btn btn-payment"> 
													<Image alt="aforliyah" priority layout="intrinsic" width={50} height={30} src="/assets/imgs/template/icons/mastercard.png" />
												</div>
											</SwiperSlide>
											<SwiperSlide>
												<div className="btn btn-payment"> 
													<Image alt="aforliyah" priority layout="intrinsic" width={50} height={30} className="light-mode" src="/assets/imgs/template/icons/skrill.png" />
												</div>
											</SwiperSlide>
										</div>
									</Swiper>
