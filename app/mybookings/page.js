...
export default function Mybookings(){
    ...
    useEffect(() => {
		const fetchData = async (value) => {
		  try {
			const resp = await axios.post(`${process.env.NEXT_PUBLIC_HOST}/`, { email : value, request_type : 'fetch_bookings' });
    ...
    const columns = [
        ...
        { field: 'reference', headerName: 'Reference No', width: 150 },
        { field: 'amount', headerName: 'Amount', width: 150 },
        { field: 'passport', headerName: 'Passport No', width: 150 },
        { field: 'date', headerName: 'Date', width: 150 },
        { field: 'booking_type', headerName: 'Booking Type', width: 150 },
      ];

      const column = [
        { dataField: 'id', text: 'ID' },
        { dataField: 'customerName', text: 'Customer Name' },
        { dataField: 'flight', text: 'Flight' },
        { dataField: 'date', text: 'Date' },
        { dataField: 'status', text: 'Status' },
      ];
      
      const data = [
        { id: 1, customerName: 'John Doe', flight: 'A101', date: '2024-12-01', status: 'Confirmed' },
        { id: 2, customerName: 'Jane Smith', flight: 'B202', date: '2024-12-02', status: 'Pending' },
      ];
			...
			<main style={{ background: "var(--bs-gray-100)" }} className="main">
				...
				<section className="box-section box-breadcrumb background-100">
					<div className="container"> 
						...
						<li> <span className="text-breadcrumb">My Bookings</span></li>
						</ul>
					</div>
				</section>
