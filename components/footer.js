						...
						<div className="footer-top">
							...
							<div className="col-12">
								<p className="text-white" >
									<b>AFROLIYAH TRAVELS, AFOTRAVELS.COM,</b> EXPRESS RESERVE, TODAYS ONLY DEAL, and PRICELOANER are service marks or registered service marks of afroliyah.com LLC. 
									All material herein © 2024 <b>afrotravels.com LLC,</b> all rights reserved. Afoliyah Travels specializes in affordable travel solutions, offering a variety of services including flexible pricing options, last-minute deals, and discounted travel packages that combine flights, hotels, and car rentals for added savings. Our exclusive offers allow travelers to book confidently with savings on bundled deals, and our VIP Rewards program offers points on every booking, redeemable for future trips. Customers can also earn extra rewards through select car rental partners. Whether you’re planning a spontaneous getaway or a well-organized trip, Afoliyah Travels makes your journey affordable and stress-free. Visit us at <b>Suite 108, GCL Plaza, Aminu Kano Crescent, Wuse II, FCT-Abuja, Nigeria</b>.
								</p>
								<hr/>
							</div>
							</div>
							<div className="row">
								...
								<div className="col-md-2 col-xs-6 footer-3">
									...
									<ul className="menu-footer">
										<li><Link className="text-sm neutral-300" href="/aboutus">About Us</Link></li>
										<li><Link className="text-sm neutral-300" href="/contact">Contact Us</Link></li>
										<li><Link className="text-sm neutral-300" href="/faq">Faq</Link></li>
									</ul>
								</div>
								...
								<div className="col-md-2 col-xs-6 footer-4">
									...
									<ul className="menu-footer">
									  <li><Link className="text-sm neutral-300" href="/">Flight Booking</Link></li>
									  <li><Link className="text-sm neutral-300" href="/">Hotel Booking</Link></li>
								...
								<div className="col-md-2 col-xs-6 footer-5">
									...
									<ul className="menu-footer">
									  <li><Link className="text-sm neutral-300" href="terms">Terms of Service</Link></li>
									  <li><Link className="text-sm neutral-300" href="privacy">Privacy Policy</Link></li>
									  <li><Link className="text-sm neutral-300" href="cookie">Cookies Policy</Link></li>
